...
public class AportesAdapter extends RecyclerView.Adapter<AportesAdapter.transaccionesholder>  {
    ...
    public AportesAdapter(List<Transacciones> listtransacciones, Context context, Fragment_histo_ap f){
    ...
    public transaccionesholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AportesAdapter.transaccionesholder(v);
    ...
    @Override
    public void onBindViewHolder(@NonNull AportesAdapter.transaccionesholder holder, final int position) {
