...
public class Fragment_histo_rt  extends Fragment  implements Response.ErrorListener, Response.Listener<JSONObject> {

    private RecyclerView rv;
    private RetirosAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_histo_rt, container, false);
        ...
        adapter = new RetirosAdapter(listTransacciones,getContext(),this);
    ...
    public void cargarservice(){
        ...
        String url="http://www.marlonmym.tk/chulki/consulta_transaciones/c_retiros.php?ci_us="+cog_comu;
        jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,url,null, this,this);
        request.add(jsonObjectRequest);}

    public void onErrorResponse(VolleyError error) {
        Toast.makeText(getContext(), "No hay retiros" , Toast.LENGTH_LONG).show();
