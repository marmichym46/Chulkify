...
public class Fragment_histo_tran extends Fragment  implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_histo_tran, container, false);
        ...
        adapter = new TransaccionesAdapter(listTransacciones,getContext(),this);
    ...
    public void cargarservice(){
        ...
        String url="http://www.marlonmym.tk/chulki/consulta_transaciones/c_transacciones.php?ci_us="+cog_comu;
