...
public class TransaccionesAdapter extends RecyclerView.Adapter<TransaccionesAdapter.transaccionesholder> {

List<Transacciones> listtransacciones;
Context context;
Fragment_histo_tran f;

    public TransaccionesAdapter(List<Transacciones> listtransacciones, Context context, Fragment_histo_tran f){
    ...
    public transaccionesholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TransaccionesAdapter.transaccionesholder(v);
    ...
    @Override
    public void onBindViewHolder(@NonNull TransaccionesAdapter.transaccionesholder holder, final int position) {
